...
import { EyeIcon, MessageCircle, MessageSquare, MessageSquareHeartIcon } from 'lucide-react'
        ...
        <div className='flex flex-col gap-3'>
          {
            connections.map((user)=>(
              <div key={user._id} className='max-w-xl flex flex-wrap gap-5
              p-6 bg-white shadow rounded-md'>
                ...
                <div className='flex flex-col gap-2 mt-4'>
                  ...
                  rounded bg-slate-100 hover:bg-slate-200 
                  active:scale-95 transition cursor-pointer gap-1'>
                    <MessageSquareHeartIcon className='w-4 h-4'/>
                  </button>
