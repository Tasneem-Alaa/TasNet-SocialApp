...
const ProfileModal = ({setShowEdit}) => {
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110
    h-screen overflow-y-scroll bg-black/50'>
        <div className='max-w-2xl sm:py-6 mx-auto p-6'>
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/profile relative'>
                                ...
                                top-0 bottom-0 left-0 right-0 bg-black/20 cursor-pointer
                        ...
                        text-gray-700 mb-1'>
                            ...
                            <div className='group/cover relative'>
                                <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo)
                                    ...
                                    className='w-80 h-40 rounded-lg bg-linear-to-r from-indigo-200 via-purple-200 to-pink-200
                                    object-cover mt-2'/>

                                    <div className=' absolute hidden group-hover/cover:flex cursor-pointer
                                    top-0 left-0 right-0 bottom-0 bg-black/20 rounded-lg items-center justify-center'>
                                        <PencilIcon className='w-5 h-5 text-white'/>
                                    </div>
                            </div>
                        </label>
                    ...
                    {/* btns */}
                    <div className='flex jus  space-x-3 pt-6'>
                        <button onClick={()=>setShowEdit(false)} type='button' className='px-4 py-2 border border-gray-300 rounded-lg
                        text-gray-700 hover:bg-gray-50 transition-colors hover:scale-105 cursor-pointer'>Cancel</button>

                        <button type='submit' className='px-4 py-2 border border-gray-300 rounded-lg
                        bg-linear-to-r from-purple-800 to-pink-400 text-white font-bold 
                        duration-300 ease-in-out text-sm hover:scale-105 hover:shadow-[0_0_20px_rgba(167,123,234,0.6)] 
                        hover:from-purple-500 hover:to-pink-300 active:scale-95 cursor-pointer transition'>Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
