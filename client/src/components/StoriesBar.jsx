  ...
  return (
    ...
    lg:max-w-2xl px-4'>
        <div className='flex gap-4 pb-5'>
            ...
            max-w-30 max-h-40 aspect-[3/4] cursor-pointer hover:shadow-lg 
            transition-all duration-200 border-2 border-dashed 
            border-indigo-300 bg-linear-to-b from-indigo-50 to-white'>
                <div className='h-full flex flex-col items-center justify-center p-4'>
                    <div className='size-10 bg-indigo-500 rounded-full 
                                ...
                                bg-black overflow-hidden'>
                                    {
                                        ...
                                        w-full object-cover hovel-scale-110 transition 
